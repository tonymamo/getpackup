        ...
        <Column sm={8} smOffset={2}>
          <Box>
            <div style={{ textAlign: 'center', marginBottom: doubleSpacer }}>
              ...
              <HorizontalRule />
              <p>
                We&apos;re a small team building Packup on nights and weekends, entirely
                self-funded. Every dollar you contribute goes directly into making the app better,
                whether that&apos;s adding new functionality, improving core features, or keeping
